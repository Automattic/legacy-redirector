Feature: Enable and disable redirects
  ...
  Scenario: Disable and re-enable a redirect
    ...
    When I run `wp legacy-redirector disable /toggle-source`
    Then STDOUT should contain:
      """
      Success: Disabled redirect: /toggle-source
      """

    When I run `wp legacy-redirector get /toggle-source`
    Then STDOUT should contain:
      """
      disabled
      """

    When I run `wp legacy-redirector enable /toggle-source`
    Then STDOUT should contain:
      """
